...
<select name="wr_1" id="wr_1" required>
    ...
    <option value="0"<?php echo ($write['wr_1'] == "0") ? " selected" : "";?>>0</option>
	<option value="1"<?php echo ($write['wr_1'] == "1") ? " selected" : "";?>>1</option>
    <option value="1.5"<?php echo ($write['wr_1'] == "1.5") ? " selected" : "";?>>1.5</option>
    <option value="2"<?php echo ($write['wr_1'] == "2") ? " selected" : "";?>>2</option>
    <option value="2.5"<?php echo ($write['wr_1'] == "2.5") ? " selected" : "";?>>2.5</option>
    <option value="3"<?php echo ($write['wr_1'] == "3") ? " selected" : "";?>>3</option>
	<option value="3.5"<?php echo ($write['wr_1'] == "3.5") ? " selected" : "";?>>3.5</option>
    <option value="4"<?php echo ($write['wr_1'] == "4") ? " selected" : "";?>>4</option>
    <option value="4.5"<?php echo ($write['wr_1'] == "4.5") ? " selected" : "";?>>4.5</option>
    <option value="5"<?php echo ($write['wr_1'] == "5") ? " selected" : "";?>>5</option>
